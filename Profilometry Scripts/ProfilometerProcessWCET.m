...
close all;
clc;
FigHandle = figure('Position', [100, 100, 2400, 1200]);
...
caxis([-27.5 27.5])
view(45,60)
xlabel('Axial Distance (µm)','FontSize', 12, 'FontWeight','bold');
ylabel('Circumferential Distance (µm)','FontSize', 12, 'FontWeight','bold');
...
pos = get(xh, 'Position');
set(xh, 'Position',pos.*[0.65,3.0,1],'Rotation',-19)

yh = get(gca,'YLabel'); % Handle of the y label%set(yh, 'Units', 'Normalized')
set(yh, 'Units', 'Normalized')
pos = get(yh, 'Position');
set(yh, 'Position',pos.*[1.05,-2.5,1],'Rotation',20)
